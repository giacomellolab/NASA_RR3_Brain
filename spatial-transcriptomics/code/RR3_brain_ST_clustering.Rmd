...
visium.dir <- "path to directory with all count data"

# Path for where the plots will be exported to
export_path = "path of the directory where results can be saved"
```
...
#read the mm10_genes.tsv file from the "spatial-transcriptomics/data" folder
enids <- read.table(file = "~/mm10_genes.tsv", header = T, stringsAsFactors = T)
...
```{r}
coldef <- c("#004A55", "#0031D4", "#00CBD4", "#006A21", "#799400","#FFD66A", "#D4C200", "#D6E279","#D4D6FF", "#D3AAFF", "#7500BF","#AA0084", "#FF9A94", "#FF8861","#D43938", "#946E55", "#7F1100", "#9B9A9A")
